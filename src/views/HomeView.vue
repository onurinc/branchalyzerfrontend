    ...
    <main class="isolate">
        ...
        <div class="mt-16 flex justify-center">
          ...
          >
            <span class="hidden md:inline"
              >Lorem ipsum saves up to $4,000 per year, per employee by working
              with us.</span
            >
      ...
      <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
        <div class="mx-auto max-w-2xl lg:text-center">
          ...
          >
            Everything you need to Lorem Ipsum your app
          </p>
          <p class="mt-6 text-lg leading-8 text-gray-600">
...
const tiers = [
  {
    ...
    href: "#",
    priceMonthly: "$24",
    description: "Donec gravida diam eu porttitor condimentum. ",
    features: [
      "Donec gravida diam.",
      "Donec gravida diam.",
      "Donec gravida diam.",
